 ...
 * under the License.
 */
var r={};r.version={major:4,minor:0,build:1},r.utils=e("./lib/utils.js"),r.xml=e("./lib/xml.js"),r.oData=e("./lib/odata.js"),r.utils.inBrowser()&&(window.odatajs=r),"undefined"!=typeof t&&(r.node="node",t.exports=r)},{"./lib/odata.js":12,"./lib/utils.js":19,"./lib/xml.js":20}],12:[function(e,t,n){/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
 * regarding copyright ownership.  The ASF licenses this file
 ...
 * under the License.
 */
var M=e("./../utils.js"),A=e("./odatautils.js"),w=e("./handler.js"),O="odata",j=O+".",D="@"+j+"context",G=M.assigned,k=M.defined,V=M.isArray,I=M.isObject,B=M.parseInt10,$=M.getFormatKind,R=M.convertByteArrayToHexString,L=(A.formatDateTimeOffset,A.formatDuration),F=A.formatNumberWidth,q=(A.getCanonicalTimezone,A.handler,A.isComplex,A.isPrimitive),U=A.isCollectionType,H=A.lookupComplexType,Q=A.lookupEntityType,J=A.lookupSingleton,K=A.lookupEntitySet,z=A.lookupDefaultEntityContainer,W=A.lookupProperty,Y=A.MAX_DATA_SERVICE_VERSION,X=A.maxVersion,Z=A.isPrimitiveEdmType,ee=A.isGeographyEdmType,te=A.isGeometryEdmType,ne="f",re="e",ie="p",ae="c",oe="s",se="erl",ue="erls",le="v",pe="f",de="de",ce="l",fe="dl",ye="application/json",he=w.contentType(ye),me=["@odata.id","@odata.type"],ge=/^\/Date\((-?\d+)(\+|-)?(\d+)?\)\/$/,ve=function(e,t){return t&&"Edm.Time"===t.__edmType?L(t):t},xe=w.handler(r,i,ye,Y);xe.recognizeDates=!1,n.createPayloadInfo=_,n.jsonHandler=xe,n.jsonParser=r,n.jsonSerializer=i,n.parseJsonDateString=C},{"./../utils.js":19,"./handler.js":14,"./odatautils.js":18}],16:[function(e,t,n){/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
 * regarding copyright ownership.  The ASF licenses this file
 ...
 * under the License.
 */
var c=e("./../utils.js"),f=c.defined,y=c.delay,h=0;n.defaultHttpClient={callbackParameterName:"$callback",formatQueryString:"$format=json",enableJsonpCallback:!1,request:function(){return function(e,t,n){var o,d={},c=null,m=!1;d.abort=function(){o=l(o),m||(m=!0,c&&(c.abort(),c=null),n({message:"Request aborted"}))};var g,v=function(){o=l(o),m||(m=!0,c=null,n({message:"Request timed out"}))},x=e.requestUri,E=f(e.enableJsonpCallback,this.enableJsonpCallback),b=f(e.callbackParameterName,this.callbackParameterName),T=f(e.formatQueryString,this.formatQueryString);if(!E||s(x)){if(c=a(),c.onreadystatechange=function(){if(!m&&null!==c&&4===c.readyState){var r=c.statusText,i=c.status;1223===i&&(i=204,r="No Content");var a=[];p(c,a);var o={requestUri:x,statusCode:i,statusText:r,headers:a,body:c.responseText};m=!0,c=null,i>=200&&i<=299?t(o):n({message:"HTTP request failed",request:e,response:o})}},c.open(e.method||"GET",x,!0,e.user,e.password),e.headers)for(g in e.headers)c.setRequestHeader(g,e.headers[g]);e.withCredentials&&(c.withCredentials=!0),e.timeoutMS&&(c.timeout=e.timeoutMS,c.ontimeout=v),"undefined"==typeof e.body?c.send():c.send(e.body)}else{if(!r(e))throw{message:"Request is not local and cannot be done through JSONP."};var C=h;h+=1;var S,_=C.toString(),P=!1;g="handleJSONP_"+_,window[g]=function(e){if(o=l(o),!m){P=!0,window.clearTimeout(S),u(g,C),window.ActiveXObject&&(e=window.JSON.parse(window.JSON.stringify(e)));var n;n=T&&"$format=json"!=T?{"Content-Type":T.substring(8),"OData-Version":"4.0"}:{"Content-Type":"application/json;odata.metadata=minimal","OData-Version":"4.0"},y(function(){l(o),t({body:e,statusCode:200,headers:n})})}};var N=e.timeoutMS?e.timeoutMS:12e4;S=window.setTimeout(v,N);var M=b+"=parent."+g;T&&(M+="&"+T);var A=x.indexOf("?");A===-1?x=x+"?"+M:A===x.length-1?x+=M:x=x+"&"+M,o=i(x)}return d}}()},n.canUseJSONP=r,n.isAbsoluteUrl=o,n.isLocalUrl=s},{"./../utils.js":19}],18:[function(e,t,n){/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
 * regarding copyright ownership.  The ASF licenses this file
 ...
 * under the License.
 */
"use strict";function r(){return"undefined"!=typeof window}function i(e){return null!==e&&void 0!==e}function a(e,t){var n,r;for(n=0,r=e.length;n<r;n++)if(e[n]===t)return!0;return!1}function o(e,t){return void 0!==e?e:t}function s(e){if(1===arguments.length)return void window.setTimeout(e,0);var t=Array.prototype.slice.call(arguments,1);window.setTimeout(function(){e.apply(this,t)},0)}function u(e,t,n){if(!e)throw{message:"Assert fired: "+t,data:n}}function l(e,t){for(var n in t)e[n]=t[n];return e}function p(e,t){if(e){var n,r;for(n=0,r=e.length;n<r;n++)if(t(e[n]))return e[n]}return null}function d(e){return"[object Array]"===Object.prototype.toString.call(e)}function c(e){return"[object Date]"===Object.prototype.toString.call(e)}function f(e){return"object"==typeof e}function y(e){return parseInt(e,10)}function h(e,t,n){e.hasOwnProperty(t)&&(e[n]=e[t],delete e[t])}function m(e){throw e}function g(e){return e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function v(e,t){return void 0!==e?e:t}function x(e){var t={isAbsolute:!1};if(e){var n=V.exec(e);if(n){var r,i;for(r=0,i=I.length;r<i;r++)n[r+1]&&(t[I[r]]=n[r+1])}t.scheme&&(t.isAbsolute=!0)}return t}function E(e){return"".concat(e.scheme||"",e.authority||"",e.path||"",e.query||"",e.fragment||"")}function b(e){var t=x(e),n=t.scheme,r=t.authority;if(n&&(t.scheme=n.toLowerCase(),r)){var i=B.exec(r);i&&(t.authority="//"+(i[1]?i[1]+"@":"")+i[2].toLowerCase()+(i[3]?":"+i[3]:""))}return e=E(t),e.replace($,function(e){return e.toLowerCase()})}function T(e,t){if(!t)return e;var n=x(e);if(n.isAbsolute)return e;var r,i=x(t),a={};return n.authority?(a.authority=n.authority,r=n.path,a.query=n.query):(n.path?(r="/"===n.path.charAt(0)?n.path:C(n.path,i.path),a.query=n.query):(r=i.path,a.query=n.query||i.query),a.authority=i.authority),a.path=S(r),a.scheme=i.scheme,a.fragment=n.fragment,E(a)}function C(e,t){var n,r="/";return t&&(n=t.lastIndexOf("/"),r=t.substring(0,n),"/"!==r.charAt(r.length-1)&&(r+="/")),r+e}function S(e){for(var t,n="",r="";e;)0===e.indexOf("..")||0===e.indexOf(".")?e=e.replace(/^\.\.?\/?/g,""):0===e.indexOf("/..")?(e=e.replace(/^\/\..\/?/g,"/"),t=n.lastIndexOf("/"),n=t===-1?"":n.substring(0,t)):0===e.indexOf("/.")?e=e.replace(/^\/\.\/?/g,"/"):(r=e,t=e.indexOf("/",1),t!==-1&&(r=e.substring(0,t)),n+=r,e=e.replace(r,""));return n}function _(e){var t=[];if(void 0===window.atob)t=P(e);else for(var n=window.atob(e),r=0;r<n.length;r++)t.push(n.charCodeAt(r));for(var i="",a="0123456789ABCDEF",o=0;o<t.length;o++){var s=t[o];i+=a[s>>4],i+=a[15&s]}return i}function P(e){for(var t="",n=0;n<e.length;n++){var r=N(e[n]),i="";null!==r&&(i=r.toString(2),t+=M(i))}var a=[],o=parseInt(t.length/8,10);for(n=0;n<o;n++){var s=parseInt(t.substring(8*n,8*(n+1)),2);a.push(s)}return a}function N(e){var t=e.charCodeAt(0),n=65,r=6;return t>=65&&t<=90?t-n:t>=97&&t<=122?t-n-r:t>=48&&t<=57?t+4:"+"==e?62:"/"==e?63:null}function M(e){for(;e.length<6;)e="0"+e;return e}function A(e){return e&&e.value?e.value.length:0}function w(e,t,n){if(void 0===e||void 0===e.value)return e;t<0&&(t=0);var r=A(e);r<n&&(n=r);var i={};for(var a in e)"value"==a?i[a]=e[a].slice(t,n):i[a]=e[a];return i}function O(e,t){return void 0===t||void 0===t.value?e:void 0===e||0===Object.keys(e).length?t:void 0===e.value?(e.value=t.value,e):(e.value=e.value.concat(t.value),e)}function j(e,t){return e.indexOf(t,e.length-t.length)!==-1}function D(e,t){return 0===e.indexOf(t)}function G(e,t){var n=t;if(!i(e))return n;var r=e.toLowerCase();switch(r){case"none":n=0;break;case"minimal":n=1;break;case"full":n=2}return n}var k=function(e){return window.ActiveXObject?new window.ActiveXObject(e):null},V=/^([^:\/?#]+:)?(\/\/[^\/?#]*)?([^?#:]+)?(\?[^#]*)?(#.*)?/,I=["scheme","authority","path","query","fragment"],B=/^\/{0,2}(?:([^@]*)@)?([^:]+)(?::{1}(\d+))?/,$=/%[0-9A-F]{2}/gi;n.inBrowser=r,n.activeXObject=k,n.assigned=i,n.contains=a,n.defined=o,n.delay=s,n.djsassert=u,n.extend=l,n.find=p,n.getURIInfo=x,n.isArray=d,n.isDate=c,n.isObject=f,n.normalizeURI=T,n.normalizeURICase=b,n.parseInt10=y,n.renameProperty=h,n.throwErrorCallback=m,n.trimString=g,n.undefinedDefault=v,n.decodeBase64=P,n.convertByteArrayToHexString=_,n.getJsonValueArraryLength=A,n.sliceJsonValueArray=w,n.concatJsonValueArray=O,n.startsWith=D,n.endsWith=j,n.getFormatKind=G},{}],20:[function(e,t,n){/*
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
 * regarding copyright ownership.  The ASF licenses this file
